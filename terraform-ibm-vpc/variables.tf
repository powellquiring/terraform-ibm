...
variable "resource_group" {
  description = "Resource group id for the vpc"
  default     = ""
}
...
# Use either private_subnets or private_subnets_count but not both
/*
  private_subnets  = [
    ["us-south-1", "10.240.0.0/24"]
    ["us-south-2", "10.240.64.0/24"]
    ["us-south-2", "10.240.65.0/24"]
...
variable "default_network_acl" {
  description = "Default network acl for the vpc"
  default     = ""
}
